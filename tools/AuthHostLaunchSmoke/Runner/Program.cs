...
if (actualEvidencePath is not null)
{
    ...
    var precheckMatched = actualResult.Status == ServiceLib.Models.Dto.SubscriptionQuotaStatusCode.LoginRequired;
    await WriteEvidenceAsync(actualEvidencePath, new
    {
        status = precheckMatched ? "PRECHECK_ONLY" : "FAIL",
        verifiedLoginFlow = false,
